...
<%
	...
	String total_amount = new String(request.getParameter(
			"WIDtotal_amount").getBytes("ISO-8859-1"), "UTF-8");
	//订单名称，必填
	...
	String json = "{" + ChangeUtil.changeJson("订单号", out_trade_no)
			+ "," + ChangeUtil.changeJson("付款金额", total_amount) + ","
			+ ChangeUtil.changeJson("订单ID", OrderID) + "}";

	List<String> list = new ArrayList<String>();
	list.add(json);

	ChangeUtil.sessionpotting("JiaoYi", list, true, -1,
			request.getSession());
