...
<body>
		...
		<div class="container-fluid">
			...
			<table class="table table-bordered"
				...
				<tr style="border: 2px solid #ccddf5;">
					<td style="vertical-align:middle" colspan='5'>个人信息</td>
				...
				<tr style="border: 2px solid #ccddf5;" align='center'>
					<td style="vertical-align:middle"><label style="color: red">*</label>姓名：</td>
					<td style="vertical-align:middle" id="customname"
						ondblclick="update(this.id)">${custom.getCustomname() }</td>
					<td style="vertical-align:middle"><label style="color: red">*</label>身份证号码：</td>
					<td style="vertical-align:middle" colspan='2' id="customidnumber"
						ondblclick="update(this.id)">${custom.getCustomidnumber() }</td>



				</tr>
				<tr style="border: 2px solid #ccddf5;">
					<td style="vertical-align:middle"><label style="color: red">*</label>昵称：</td>
					<td style="vertical-align:middle" id="customerusername"
						ondblclick="update(this.id)">${custom.getCustomerusername() }</td>
					<td style="vertical-align:middle"><label style="color: red">*</label>性别：</td>
					<td style="vertical-align:middle" colspan='2' id="sex"
						ondblclick="update(this.id)">${ custom.getSex() }</td>
				...
				<tr style="border: 2px solid #ccddf5;">
					...
					<td style="vertical-align:middle" colspan='4'>${custom.getCustomername()
						}</td>
				...
				<tr style="border: 2px solid #ccddf5;">
					...
					<td style="vertical-align:middle" id="qq" ondblclick="update(this.id)">${custom.getQq()
						}</td>
				...
				<tr>
					...
					<td style="vertical-align:middle" colspan='3'><button class=" btn"
							onclick="updatepassword()" style="cursor: pointer;">修改密码</button>
					</td>
				</tr>
			...
			<div id="aggregate">
				<input type="text" id="sex2" maxlength="20" name="sex"
					value="${custom.getSex()}" readonly="readonly" class="hidden" /> <input
					type="text" id="customerusername2" maxlength="20" name="customerusername"
					value="${custom.getCustomerusername() } " readonly="readonly"
					class="hidden" /><input type="text" id="customidnumber2" maxlength="20"
					name="customidnumber" value="${custom.getCustomidnumber() }"
					readonly="readonly" class="hidden" /> <input type="text" id="customname2"
					maxlength="20" name="customname" value="${custom.getCustomname() }"
					readonly="readonly" class="hidden" /> <input type="text" id="qq2"
					maxlength="20" name="qq" value="${custom.getQq()
						}"
					readonly="readonly" class="hidden" /> <input type="text" id="mailbox2"
					maxlength="20" name="mailbox" value="${custom.getMailbox() }"
					readonly="readonly" class="hidden" /> <input type="text"
					id="customphonenumber2" maxlength="20" name="customphonenumber"
	...
	<script type="text/javascript">
		...
		var picture = '${custom.getCustomidphoto() }';
		var str;
		var OriginalText;
		$(function() {
					...
					.alert(
							...
							function(index) {
								...
								if ($("#fileName").val() != null
									...
									$("#formdata")
											.attr("action",
													"${ctx}/ClientController/updatePersonal.do");
