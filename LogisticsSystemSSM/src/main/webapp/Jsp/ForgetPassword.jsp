...
<body class="bgf4">
	<div class="content">
		<div class="top">
			...
			<div class="logo-fr">
				<a href="${ctx }/Jsp/Login.jsp">返回登录界面</a>
						...
						<div class="part4 text-center" style="display:none">
							...
							<p class="c-666 f-mt30 f-mb50">
								页面将在 <strong id="times" class="f-size18">10</strong> 秒钟后，跳转到 <a
									href="${ctx }/Jsp/Login.jsp" class="c-blue">物流登录界面</a>
							</p>
						</div>
					</form>
				</div>
	...
	<script type="text/javascript">
		...
		$("#btn_part1").click(
				function() {
					...
					$.post("${ctx}/LoginController/checkPhoneNumber.do?phone="
							+ phone + "&code=" + code, function(data) {
		...
		function next() {
			...
			$.post("${ctx}/ClientController/verficationPhone.do?PhoneCode="
		...
		function rest() {
			...
			var phoneNumber = $("#phone").val();
			$.post("${ctx}/LoginController/updatePassword.do?password="
					+ password + "&confirmPassword=" + confirmPassword
					+ "&phoneNumber=" + phoneNumber, function(data) {
				if ((typeof data) == "string") {
					data = JSON.parse(data);
				}
				if (data.state == true) {
